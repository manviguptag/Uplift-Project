...
private:
 ...
 // The function below gives the result played by computer. In this a random position is picked by computer with the help of rand function.
    void computerInput(){
        int pos;
        pos = rand()%10;
        
// Here it checks whether the placed choosen is empty or not.        
        if(emptyIndex[pos] == 1){
//Empty Count checks whether the board is empty or not.            
            if(emptyCount < 0)
                return;
            computerInput();
        } else {
            ...
            emptyIndex[pos] =1;
// Empty Count is decreases by 1, i.e., one placed is filled.            
            emptyCount-=1;
            board[pos] = 'O';
        }
 ...
 //Below function shows the result of input by player. 
    void playerInput(Player &player){
        ...
        cin >> pos;
        pos -=1;
// Checks whether the position entered is empty or not.        
        if(emptyIndex[pos] == 1){
            ...
            emptyIndex[pos] =1;
            emptyCount-=1;
// Below shows that player 1 will choose X and Player 2 will choose O for it's symbol.           
    ...
    void checkWin(Player &p1,Player &p2){
        ...
        for(i=0; i<8; i++){
            ...
            flag = true;
            for(j=0;j<3;j++){
// This will check winning condition.            
...
public:
    Game(): emptyCount{0}, gameOn{1}, againstComputer{0}{
        init();
// These are tye winning combinations.        
    ...
    void init(){
        ...
        emptyCount =0;
        srand(time(0));
        // size_t returns the maximum size of the theoritical object. It is always non negative.
